import os
from functions import carregar_dados, carregar_dados_resultados, calcular_resultados, gerar_graficos_carga_horario_professor
from functions import gerar_graficos_quantidade_turmas_professor, gerar_graficos_resultado_liquido_turma
...
for subpasta, x, arquivos in os.walk(diretorio):
    for arquivo in arquivos:
        ...
        if arquivo.endswith(".csv"):                        
            ...
            if arquivo.startswith("resultado_melhor_solucao_BT"):
